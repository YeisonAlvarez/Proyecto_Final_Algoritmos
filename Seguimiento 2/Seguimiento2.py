...
if df_articles is not None:
    ...
    tab1, tab2, tab3 = st.tabs(["📊 Requerimiento 2: Similitud Textual",
                                "📈 Requerimiento 3: Frecuencias y Keywords IA",
        ...
        with subtab1:
            ...
            if st.button("Construir Grafo de Citaciones", type="primary"):
                if not selected:
                    ...
                    # Guardar datos en sesión para evitar recalcular
